...
class homecontroller extends Controller
{
    ...
    {
        $newproducts = Product::where('trangthai', 1)->orderBy('ngaycapnhat', 'DESC')->take(20)->get();
        $newproducts2 = Product2::where('trangthai', 1)->orderBy('ngaycapnhat', 'DESC')->take(10)->get();
        $data = [
            'title' => 'Trang chủ',
