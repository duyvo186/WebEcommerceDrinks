<meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{asset('public/frontend/css/day.css')}}">
    <link rel="stylesheet" href="{{asset('public/frontend/css/okay.css')}}">
    <link rel="stylesheet" href="{{asset('public/frontend/css/hi.css')}}">
